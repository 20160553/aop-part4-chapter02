...
import fastcampus.aop.part3.chapter04.databinding.FragmentPlayerBinding
import fastcampus.aop.part3.chapter04.service.MusicDto
import fastcampus.aop.part3.chapter04.service.MusicService
...
class PlayerFragment: Fragment(R.layout.fragment_player) {
    ...
    private fun updatePlayerView(currentMusicModel: MusicModel?) {
        ...
        binding?.let { binding ->
            ...
            Glide.with(binding.coverImageCardView)
    ...
    private fun initPlayListButton(fragmentPlayerBinding: FragmentPlayerBinding) {
        fragmentPlayerBinding.playlistImageView.setOnClickListener {
            ...
            fragmentPlayerBinding.playerViewGrouop.isVisible = model.isWatchingPlayListView
            fragmentPlayerBinding.playListViewGrouop.isVisible = model.isWatchingPlayListView.not()
